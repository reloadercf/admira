...
const links = [
    ...
    { name: "Google Ads API", href: "ads" },
    { name: "Meta Ads API", href: "meta"},
    { name: "Sistema CRM", href:"crm"}
  ];
          ...
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                ...
                >
                  {/* Logo */}
                  <img src="https://cdn.prod.website-files.com/660b7c74d20e45c2022e472a/660c5d30f4b0828e899aa06e_admira.svg" alt="logo" className="h-10" />
                </Link>
              </div>
              <div className="flex items-center">
                {/* User Avatar */}
                <img src="https://media.licdn.com/dms/image/D5603AQFZEosMxMFeBA/profile-displayphoto-shrink_200_200/0/1679867517998?e=1728518400&v=beta&t=a53U6SvtlRMZbq6Oqm8Eh71QUhHqX4POebpX9lsPdYQ" className="p-2 rounded-full w-14 h-14" />
